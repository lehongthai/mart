            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li>
                        ...
                        <ul class="ml-menu">
                            <li>
                                <a href="{{ route('manager.index') }}" class="menu-toggle">
                                    <span>Manager</span>
                                </a>
                            </li>
                        </ul>
                    ...
                    <li>
                        ...
                        <ul class="ml-menu">
                            <li>
                                <a href="{{ route('category.index') }}" class="menu-toggle">
                    ...
                    <li>
                        ...
                        <ul class="ml-menu">
                            <li>
                                <a href="{{ route('post.index') }}" class="menu-toggle">
                    ...
                    <li>
                        ...
                        <ul class="ml-menu">
                            <li>
                                <a href="{{ route('slider.index') }}" class="menu-toggle">
                    ...
                    <li>
                        ...
                        <ul class="ml-menu">
                            <li>
                                <a href="{{ route('block.index') }}" class="menu-toggle">
                    ...
                    <li>
                        ...
                        <ul class="ml-menu">
                            <li>
                                <a href="{{ route('setting.index') }}" class="menu-toggle">
                                    <span>List Setiing</span>
                                </a>
                            </li>
                        </ul>
                    </li>
