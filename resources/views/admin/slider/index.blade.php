                    ...
                    <div class="card">
                        <div class="header">
                            ...
                            <ul class="header-dropdown m-r--5">
                                <a class="btn btn-primary m-t-15 waves-effect" href="{{ route('slider.create') }}">CREATE</a>
                            </ul>
                        </div>
                        <div class="body">
                            <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                ...
                                @foreach($listSlider as $slider)
                                    <tr>
                                        ...
                                        <td>
                                           <?php
                                                $date=date_create($slider->created_at);
                                        ...
                                        <td>
                                            <li class="dropdown pull-right" style="list-style: none">
                                                ...
                                                <ul class="dropdown-menu pull-right">
                                                    <li>
                                                        <a href="{{ route('slider.show', $slider->id) }}">Show</a>
                                                    </li>
                                                    <li>
                                                        <a href="{{ route('slider.edit', $slider->id) }}">Update</a>
                                                    </li>
                                                    <li>
                                                        <a onclick="return confirm_delete('Bạn chắc chắn xóa !')"  href="{{ route('slider.destroy', $slider->id) }}">Delete</a>
                                                    </li>
                                                </ul>
                                            </li>
                                        </td>
