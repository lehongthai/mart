...
<div class="form-group">
<div class="form-line">
<input type="text" name="name_en" value="{{ old('name_en') }}" class="form-control" placeholder="post Name" id="title_en" />
</div>
...
<div class="form-group">
<div class="form-line">
<input type="text" readonly name="slug_en" value="{{ old('slug_en') }}" class="form-control" placeholder="post Slug" id="slug_en" />
</div>
