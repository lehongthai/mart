...
<option value="{{ $cate->id }}" @if(old( 'cate_id') == $cate->id) selected @endif >{{ $cate->name }}</option>
@endforeach
</select>
...
<div class="form-group">
<div class="form-line">
<textarea rows="4" name="desc_vn" class="form-control no-resize" placeholder="Enter Description...">{{ old('desc_vn') }}</textarea>
</div>
</div>
</div>
</div>
...
<div class="form-group">
<div class="form-line">
<input type="text" name="name_en" value="{{ old('name_en') }}" class="form-control" placeholder="Product Name" id="title_en" />
</div>
...
<div class="form-group">
<div class="form-line">
<input type="text" readonly name="slug_en" value="{{ old('slug_en') }}" class="form-control" placeholder="Product Slug" id="slug_en" />
</div>
...
<div class="form-group">
<div class="form-line">
<textarea rows="4" name="desc_en" class="form-control no-resize" placeholder="Enter Description...">{{ old('desc_en') }}</textarea>
</div>
</div>
</div>
</div>
...
<input name="status" value="4" type="radio" id="radio_11" class="radio-col-deep-purple" @if(old( 'status') == 4 ) checked @endif />
<label for="radio_11">Sale</label>
<input name="status" value="5" type="radio" id="radio_12" class="radio-col-deep-purple" @if(old( 'status') == 5 ) checked @endif />
...
<div class="form-group">
<div class="form-line">
<input type="number" name="price" value="{{ old('price') }}" class="form-control" placeholder="Product Price" />
</div>
...
<div class="form-group">
<div class="form-line">
<input type="number" name="quantity" value="{{ old('quantity') }}" class="form-control" placeholder="Product Quantity" />
</div>
