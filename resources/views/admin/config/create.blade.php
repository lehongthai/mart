...
<div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        {{ csrf_field() }}
                            <h2 class="card-inside-title">CREATE CONFIG</h2>
                            <div class="row clearfix">
                            <div class="col-sm-2">
                                ...
                                <div class="col-sm-6">
                                    <select class="form-control show-tick" name="slug">
                                        ...
                                        <option value="{{ $key }}" 
                                            @if(old('slug') == $key) selected  @endif 
                                        >{{ $slug }}</option>
                                        <?php endforeach ?>
                                    </select>
                            ...
                            <div class="row clearfix">
                                ...
                                <label>Config Name</label>
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" name="name" value="{{ old('name') }}" class="form-control" placeholder="Config Name" />
                                        </div>
                                ...
                                <label>Config Value</label>
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" name="value" value="{{ old('value') }}" class="form-control" placeholder="Config Value" />
                                        </div>
