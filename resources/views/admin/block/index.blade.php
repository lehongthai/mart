                    ...
                    <div class="card">
                        <div class="header">
                            ...
                            <ul class="header-dropdown m-r--5">
                                <a class="btn btn-primary m-t-15 waves-effect" href="{{ route('block.create') }}">CREATE</a>
                            </ul>
                        </div>
                        <div class="body">
                            <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                ...
                                @foreach($listBlock as $block)
                                    <tr>
                                        <td><a href="{{ $block->link }}" target="_blank">{{ $block->name }}</a></td>
                                        <td>
                                        @if ($block->publish == 1)
                                            Publish
                                        @else
                                        ...
                                        <td>
                                            <li class="dropdown pull-right" style="list-style: none">
                                                ...
                                                <ul class="dropdown-menu pull-right">
                                                    <li>
                                                        <a href="{{ route('block.show', $block->id) }}">Show</a>
                                                    </li>
                                                    <li>
                                                        <a href="{{ route('block.edit', $block->id) }}">Update</a>
                                                    </li>
                                                    <li>
                                                        <a onclick="return confirm_delete('Bạn chắc chắn xóa !')"  href="{{ route('block.destroy', $block->id) }}">Delete</a>
                                                    </li>
                                                </ul>
                                            </li>
                                        </td>
