...
<div class="card">
<div class="body">
<form role="form" method="POST" action="{{ route('setting.update',$slug) }}">
{{ csrf_field() }}
...
<i class="material-icons">home</i> Setting Detail
</a>
</li>
<li role="presentation">
<a href="#profile_with_icon_title" data-toggle="tab">
<i class="material-icons">face</i> Seo Setting
</a>
</li>
</ul>
...
<div class="form-line">
<input type="text" name="name_vn" value="{{ old('name_vn', $e->name) }}" class="form-control" placeholder="Setting" id="title" />
</div>
...
<div class="form-group">
<div class="form-line">
<input type="text" name="name_en" value="{{ old('name_en', $e->name) }}" class="form-control" placeholder=" Name" id="title_en" />
</div>
...
<div class="form-group">
<div class="form-line">
<input type="text" readonly name="slug_en" value="{{ old('slug_en', $e->slug) }}" class="form-control" placeholder=" Slug" id="slug_en" />
</div>
...
<img src="{!! old('image_link', $detail[0]->images) !!}" id="avatar">
<hr>
<input class="form-control" name="altImage" placeholder="Chú thích ảnh" value="{!! old('altImage', $detail[0]->altImage) !!}" />
</div>
<input type="hidden" name="image_link" id="link_avatar" value="{!! old('image_link', $detail[0]->images) !!}">
