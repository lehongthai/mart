                    ...
                    <div class="card">
                        <div class="header">
                            ...
                            <ul class="header-dropdown m-r--5">
                                <a class="btn btn-primary m-t-15 waves-effect" href="{{ route('category.create') }}">CREATE</a>
                            </ul>
                        </div>
                        <div class="body">
                                        ...
                                        <td>
                                            <li class="dropdown pull-right" style="list-style: none">
                                                ...
                                                <ul class="dropdown-menu pull-right">
                                                    ...
                                                    <li>
                                                        <a onclick="return confirm_delete('Bạn chắc chắn xóa !')"  href="{{ route('category.destroy', $category->id) }}">Delete</a>
                                                    </li>
                                                </ul>
                                            </li>
                                        </td>
