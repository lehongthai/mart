...
<div class="form-line">
<input type="text" name="name_vn" value="{{ old('name_vn') }}" class="form-control" placeholder="Tên Danh Muc" id="title" />
</div>
...
<div class="form-group">
<div class="form-line">
<input type="text" name="name_en" value="{{ old('name_en') }}" class="form-control" placeholder="Category Name" id="title_en" />
</div>
...
<div class="form-group">
<div class="form-line">
<input type="text" readonly name="slug_en" value="{{ old('slug_en') }}" class="form-control" placeholder="Category Slug" id="slug_en" />
</div>
...
<input name="type" value="product" type="radio" id="radio_7" class="radio-col-red" @if(old( 'type') == 'product' ) checked @endif />
<label for="radio_7">Product</label>
<input name="type" value="post" type="radio" id="radio_8" class="radio-col-pink" @if(old( 'type') == 'post' ) checked @endif />
